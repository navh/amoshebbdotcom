...
#let info = (title: "Synthetic Post-Dive Doppler Ultrasound", date: "2024-12-02", tags: ("jax",))
#metadata(info) <frontmatter>
#show: body => post(info: info, body)

"An open-source framework for synthetic post-dive Doppler ultrasound audio generation" @Le2023.
...
Intuitively it makes sense, but my hobbyist understanding is that no actual mechanism has been proposed, let alone proven.
Bubbles are a "marker", but aren't strongly correlated with decompression sickness beyond the obvious "if you're deep into deco obligation territory and blast up to the surface, you'll obviously be both bent and bubbly".
...
- Decompression Sickness can occur after the human body experiences depressurization leading to the formation of gas bubbles. _(so right out of the gate they've lost me, I'm not sure what this sentence says, does DCS lead to formation of bubbles?)_
...
- They create a little fleshcube and run some fishtank tube through it and inject bubbles with a syringe. _(I'm worried that the bubbles that would be created from a syringe might be quite different from the bubbles that result from inert gasses leaving solution. I feel like it wouldn't be so difficult to pour soda into the reservoir, maybe ideally pressurizing the whole system and slowly letting the pressure down, but I'm probably overthinking it.)_
...
#bibliography("synthetic-post-dive-doppler-ultrasound.bib", style: "ieee")
