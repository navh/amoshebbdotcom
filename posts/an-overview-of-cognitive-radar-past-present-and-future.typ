...
#let info = (title: "An Overview of Cognitive Radar: Past Present and Future", date: "2023-06-28", tags: ("radar",))
...
In 1953, Dr Philip Woodward introduced information theory into the context of radar @woodward1953. Maximize SNR, is kinda useful for return, doesn't say anything about what to transmit to maximize information.
...
2. a powerful modelling and simulation capability for generating training data for signal-dependent interference scenarios;
3. signal processing algorithms for joint adaptive radar processing on transmit and receive;
4. waveform design and optimization principles;
5. convex optimization for adaptive radar covariance matrix estimation;
6. ambiguity function analysis and Cramer-Rao bounds for distributed passive radar (which enable sensor geometry placement and illuminator selection for maximizing system performance); and,
7. passive radar detection involving noisy reference channels with analytical performance guarantees
...
#quote[Yes, but nobody will care.]

#bibliography("an-overview-of-cognitive-radar-past-present-and-future.bib", style: "ieee")
