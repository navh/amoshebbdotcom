...
#let info = (title: "Dennard Scaling", date: "2023-01-17", tags: ("socially-responsible-computing",))
...
A formula describes MOSFET device characteristics, and some 70s numbers are plugged in. The blog version: There's a unitless "scaling factor" $kappa$, and device current is divided by $kappa$. (smaller transistors are a free lunch)
...
We measured, and everything always improves with $kappa$. No I won't justify these results! (followed by a page and a half of justification).
...
During a lecture, we discussed this paper @Dennard1974 as well.
...
#bibliography("dennard-scaling.bib", style: "ieee")
