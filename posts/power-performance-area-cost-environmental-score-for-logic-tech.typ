...
#let info = (title: "Power Performance Area Cost Environmental Score for Logic Tech", date: "2023-01-17", tags: ("socially-responsible-computing",))
...
Semiconductor manufacturing ignores life cycle assessments in favor of more performant technologies. This paper @GarciaBardon2020PPACE will review the transition from iN28 to iN3 with different scenarios for the most recent nodes. Then discuss the growing importance of exotic minerals.
...
EUV is thirsty for that zip zap. Old lights used 10 kW, we're at 100 kW now, new ones use 1000 kW. kWh/wafer has doubled. iN6 and below have some particularly electrically hungry new steps like pitch scaling.
...
#bibliography("power-performance-area-cost-environmental-score-for-logic-tech.bib", style: "ieee")
