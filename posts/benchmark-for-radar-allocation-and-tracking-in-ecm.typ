...
#let info = (title: "Benchmark for Radar Allocation and Tracking in ECM", date: "2023-06-27", tags: ("radar",))
...
// [CHECK] Reference [8, 9] mentioned in original for "Real World" definition
...
- azimuth in $-60°$ to $60°$
- radar-cross-section is $<= 18$ dB
- $18$ dB achievable with the highest energy waveform
- Stand-Off-Jammer remains at ranges near 150 km and performs less than $2g$ acceleration
...
- 3 dB beamwidth $Theta_{text("BW")}$ = $2.4°$ on broadside
- $Theta_{text("BW")}$ = $4.5°$ at broadside angle of $60°$
...
- "Since the radar time required for a dwell is typically dominated by the signal processing time" just use 0.001 s for every dwell." Note: This is round trip time, $2 times 150 times 1000 \/ (3 times 10^8) = 0.001$
...
#bibliography("benchmark-for-radar-allocation-and-tracking-in-ecm.bib", style: "ieee")
