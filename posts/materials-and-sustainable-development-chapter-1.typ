...
#let info = (title: "Materials and Sustainable Development Chapter 1", date: "2023-01-17", tags: ("socially-responsible-computing", "materials-and-sustainable-development"))
#metadata(info) <frontmatter>
#show: body => post(info: info, body)

First chapter from Michael F. Ashby's book @Ashby2015.

=== Bottom Line Up Front

I rate this 5.7.

Many very good visuals show that we're using rarer materials and more of them.
...
Old landlines had no critical elements, modern cellphones light up the periodic table like a christmas tree.
...
#bibliography("materials-and-sustainable-development-chapter-1.bib", style: "ieee")
