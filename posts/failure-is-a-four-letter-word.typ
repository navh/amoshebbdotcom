...
#let info = (title: "Failure Is a Four Letter Word", date: "2023-03-15", tags: ("emperical",))
#metadata(info) <frontmatter>
#show: body => post(info: info, body)

Andreas Zeller, Thomas Zimmermann, Christian Bird @Zeller2011FailureFourLetter.
...
Failures follow a _Pareto_ distribution. Cost of consequence: If I know a module is failure-prone because it frequently changes, should I stop changing it? This paper proposes moving work earlier, to time of typing code.
...
#bibliography("failure-is-a-four-letter-word.bib", style: "ieee")
