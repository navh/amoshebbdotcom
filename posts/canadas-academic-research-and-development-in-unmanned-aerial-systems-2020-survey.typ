...
#let info = (title: "Canadas Academic Research and Development in Unmanned Aerial Systems 2020 Survey", date: "2023-07-12", tags: ("startup",))
#metadata(info) <frontmatter>
#show: body => post(info: info, body)

Hugh H.-T. Liu

#link("https://www.flight.utias.utoronto.ca/fsc/wp-content/uploads/2020/06/uasrmap_ca_2020.pdf")[Posted on his website]
...
#bibliography("canadas-academic-research-and-development-in-unmanned-aerial-systems-2020-survey.bib", style: "ieee")
