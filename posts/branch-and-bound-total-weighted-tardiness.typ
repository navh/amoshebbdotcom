...
#let info = (title: "Branch and Bound Total Weighted Tardiness", date: "2023-03-20", tags: ("radar",))
...
@SchrageBaker1978 for dynamic programming solution.
...
@Smith1956's shortest weighted processing time rule is cheap to run, ignores due date.
...
#bibliography("branch-and-bound-total-weighted-tardiness.bib", style: "ieee")
