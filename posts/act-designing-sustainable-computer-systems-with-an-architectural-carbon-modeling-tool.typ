...
#let info = (title: "Act Designing Sustainable Computer Systems With an Architectural Carbon Modeling Tool", date: "2023-01-30", tags: ("socially-responsible-computing",))
...
_thought_ the forced acronym isn't sufficiently clever to drop the M and become un-googlable.
...
#bibliography("act-designing-sustainable-computer-systems-with-an-architectural-carbon-modeling-tool.bib", style: "ieee")
