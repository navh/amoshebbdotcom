...
#let info = (title: "In Search of an Understandable Consensus Algorithm", date: "2023-01-19", tags: ("web-scale",))
...
Diego Ongaro and John Ousterhout @ongaro2014raft
...
Keeping log consistent is job of the consensus algorithm.
...
Paxos is exceptionally difficult to understand. Full explanation is notoriously opaque, several attempts, including by Lamport, to explain it have happened. These only focus on single-decree subset. Informal survey of top researchers, most don't get it.
...
Asynchronous consensus algorithms theoretically never terminated. In practice, they work. (Paxos theoretically works, practically does not)
...
#bibliography("in-search-of-an-understandable-consensus-algorithm.bib", style: "ieee")
